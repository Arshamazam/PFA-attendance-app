  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-0.5">Manage authentication policies, IP allowlists, and session controls.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-gray-400 text-sm mt-1 max-w-xs">Password policies, multi-factor authentication, session timeouts, and IP-based access restrictions.</p>
      </div>
    </div>
  );
}
